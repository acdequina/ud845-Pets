...
public class PetProvider extends ContentProvider {
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if(rowCount != 0) {
            //notify cursor that changes was made
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                rowCount = database.delete(PetEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case PET_ID:
    ...
    public boolean isValidGender(int gender) {
        if(PetEntry.GENDER_UNKNOWN == gender
        || PetEntry.GENDER_MALE == gender
        || PetEntry.GENDER_FEMALE == gender) {
            return true;
        }
